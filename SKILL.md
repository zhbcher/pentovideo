...
- **[references/animation-recipes.md](references/animation-recipes.md)** 🆕 — Ready-to-use GSAP animation patterns. Copy-paste recipes for text animations, entrances, emphasis, transitions, combos. Read when writing scene animations.
