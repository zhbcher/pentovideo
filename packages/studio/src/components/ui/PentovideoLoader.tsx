export interface PentovideoLoaderProps {
...
export function PentovideoLoader({
  title,
  detail,
  mono,
  size = 64,
  progress,
}: PentovideoLoaderProps) {
...
export function StatusFrame(props: PentovideoLoaderProps) {
  return (
    <div className="hf-frame">
      <PentovideoLoader {...props} />
    </div>
  );
}
