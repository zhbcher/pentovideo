...
describe("PentovideoPlayer parent-frame media", () => {
  ...
  beforeEach(async () => {
    await import("./pentovideo-player.js");
    ...
    player = document.createElement("pentovideo-player") as PlayerElement;
  });
...
describe("PentovideoPlayer shader transition options", () => {
  ...
  it("passes shader options through src query parameters", () => {
    const player = document.createElement("pentovideo-player") as PlayerWithIframe;
  ...
  it("injects shader options into srcdoc before composition scripts run", () => {
    ...
    expect(srcdoc.indexOf("data-pentovideo-player-shader-options")).toBeLessThan(
...
describe("PentovideoPlayer adoptedStyleSheets", () => {
  ...
  it("shares a single CSSStyleSheet across multiple player instances", () => {
    const a = document.createElement("pentovideo-player") as PlayerWithShadow;
    const b = document.createElement("pentovideo-player") as PlayerWithShadow;
  ...
  it("does not inject a per-instance <style> when adoption succeeds", () => {
    const player = document.createElement("pentovideo-player") as PlayerWithShadow;
    document.body.appendChild(player);
...
describe("PentovideoPlayer media MutationObserver scoping", () => {
  ...
  it("attaches the observer to each top-level composition host (not the body)", () => {
    ...
    const player = document.createElement("pentovideo-player") as PlayerInternal;
    document.body.appendChild(player);
...
describe("PentovideoPlayer parent-proxy time-mirror coalescing", () => {
  type DriftEntry = {
  ...
  beforeEach(async () => {
    await import("./pentovideo-player.js");
    player = document.createElement("pentovideo-player") as PlayerInternal;
    document.body.appendChild(player);
  ...
  it("initializes new parent-media entries with driftSamples=0", () => {
    ...
    const fresh = document.createElement("pentovideo-player") as PlayerInternal;
...
describe("PentovideoPlayer seek() sync path", () => {
  type SyncPlayerStub = {
    seek?: (t: number) => void;
    play?: () => void;
    pause?: () => void;
...
describe("PentovideoPlayer loop end-state handling", () => {
  type PlayerInternal = HTMLElement & {
    iframe: HTMLIFrameElement;
    play: () => void;
...
describe("PentovideoPlayer srcdoc attribute", () => {
  type PlayerInternal = HTMLElement & {
    iframe: HTMLIFrameElement;
    _ready: boolean;
  };
  ...
  it("includes srcdoc in observedAttributes", () => {
    ...
    const ctor = customElements.get("pentovideo-player") as
...
describe("PentovideoPlayer volume and mute", () => {
  ...
  beforeEach(async () => {
    ...
    player = document.createElement("pentovideo-player") as typeof player;
  });
