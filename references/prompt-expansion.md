...
Write the expanded prompt to `.pentovideo/expanded-prompt.md` in the project directory. Do NOT dump it into the chat — it will be hundreds of lines.

Tell the user:

> "I've expanded your prompt into a full production breakdown. Review it here: `.pentovideo/expanded-prompt.md`
>
